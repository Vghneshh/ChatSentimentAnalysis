...
DATASET_PATH = 'Text/data/SS-Youtube/raw.pickle'
OUTPUT_PATH = 'Text/sentiment/finetuned/youtube_ss.hdf5'
nb_classes = 2

print("=" * 60)
print("Training YouTube Sentiment Model")
print("=" * 60)
print()
